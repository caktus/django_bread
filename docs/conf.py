...
htmlhelp_basename = 'DjangoBreaddoc'
...
latex_documents = [
  (master_doc, 'DjangoBread.tex', u'Django Bread Documentation',
   u'Caktus Consulting, LLC', 'manual'),
]
...
man_pages = [
    (master_doc, 'djangobread', u'Django Bread Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'DjangoBread', u'Django Bread Documentation',
   author, 'DjangoBread', 'One line description of project.',
   'Miscellaneous'),
]
