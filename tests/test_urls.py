...
class BreadURLsNamespaceTest(BreadTestCase):
    ...
    def test_all_views_urls_with_namespace(self):
        ...
        self.assertEqual(
            set([bread.browse_url_name(include_namespace=False),
        ...
        self.assertFalse(bread.browse_url_name(include_namespace=False)
                         .startswith(self.url_namespace + ":"))
        self.assertFalse(bread.read_url_name(include_namespace=False)
                         .startswith(self.url_namespace + ":"))
        self.assertFalse(bread.edit_url_name(include_namespace=False)
                         .startswith(self.url_namespace + ":"))
        self.assertFalse(bread.add_url_name(include_namespace=False)
                         .startswith(self.url_namespace + ":"))
        self.assertFalse(bread.delete_url_name(include_namespace=False)
                         .startswith(self.url_namespace + ":"))
